 ...
 * Class TextInitial
 *
 * Indoraptor-ийн нутагшуулалтын (localization) системд ашиглагдах
 * урьдчилсан (seed) текстүүдийг тодорхойлдог тусгай класс юм.
 *
 * Энэ класс дахь public static функцүүдийн нэр нь дараах хэлбэртэй байна:
 *      localization_text_{table}
 *
 * Эдгээр функцүүд нь тухайн орчуулгын хүснэгтийн нэршлийг илэрхийлэх ба
 * LocalizationController эдгээрийг шалгаж:
 *
 *   • аль орчуулгын хүснэгтүүд системд байх ёстой вэ,
 *   • аль хүснэгтэд эхний seed текстүүд байгаа вэ,
 *   • ямар модульд орчуулгын боломж нээлттэй вэ
 *
 * гэдгийг автоматаар тодорхойлдог.
 *
 * Тайлбар:
 * --------
 * Seed функц нь хоосон байж болно. Энэ нь тухайн орчуулгын модуль системд
 * оршин буй (registered) боловч эхний текстүүд хараахан тодорхойлогдоогүй байна
 * гэсэн утгатай. LocalizationController ийм function-ийг илрүүлдэг тул
 * хүснэгт үүсээгүй байсан ч UI дээр тухайн орчуулгын бүлэг харагдана.
 *
 * Жишээ:
 * -------
 *  localization_text_default()   → системийн үндсэн текстүүд
 *  localization_text_dashboard() → dashboard module-ийн текстүүд
 *  localization_text_user()      → хэрэглэгчийн үүсгэх custom орчуулга хадгалах (seed байхгүй байж болно)
 *
 * Хэрэв тухайн орчуулгын хүснэгтэд эхний өгөгдөл (seed data) шаардлагатай бол
 * функц дотор:
 *      $model->insert([...], [...]);
 * гэж дуудахад хангалттай. TextModel автоматаар олон хэл дээр хадгална.
 *
 * Энэ класс нь Indoraptor-ийн localization subsystem-ийн цөм хэсэг бөгөөд
...
class TextInitial
{
     ...
     *
     * Хэрэглэгчийн custom локализацийн текстүүдийг үүсгэх боломжтой.
     * Хоосон үлдээсэн нь - одоогоор системд хэрэглэгчийн анхны текстүүд шаардлагагүй гэсэн утгатай.
     *
     * Энэ function хоосон байгаа нь алдаа биш!
     *
     * Учир нь LocalizationController орчуулгын хүснэгтүүдийн жагсаалтыг:
     *    - өгөгдлийн сангийн хүснэгтүүдээс
     *    - Мөн TextInitial доторх seed function-уудаас
     * зэрэг авч бүрдүүлдэг.
     *
     * Тиймээс, хүснэгт байхгүй байсан ч
     * "localization_text_user" нэртэй орчуулгын модуль системд бүртгэлтэй гэж үзнэ.
     *
     * Хэрэв хөгжүүлэгч-д custom текст seed шаардлагатай бол
     * энэ function дотор $model->insert(...) нэмэхэд хангалттай.
     */
     ...
     *
     * Системийн үндсэн (default) текстүүдийг суулгах зориулалттай.
     * Энэ текстүүд нь бүх Indoraptor төслүүдэд нийтлэг ашиглагддаг.
     * Системийн үндсэн, заавал байх ёстой түлхүүрүүдийг нэмж байна.
     * Хоёр хэлээр: mn, en
     */
     ...
     *
     * Dashboard module-д зориулсан бүх үндсэн түлхүүрүүдийг суулгана.
     * Хэрэглэгчдэд харагдах UI текст, form validation, modal titles зэрэг багтана.
     * Хоёр хэлээр: mn, en
     */
